...
print("   - 2nd order Harmonic: " + FormatFreq(round(WavelenToFreq((fullwave/2)/1.5),4)))
print("   - 4th order Harmonic: " + FormatFreq(round(WavelenToFreq((fullwave/2)/3.5),4)))
print("   - 5th order Harmonic: " + FormatFreq(round(WavelenToFreq((fullwave/2)/4.5),4)))
print(" - Desired 1/4 wave Monopole Antenna Length: " + FormatLen(round(fullwave/4,4)))
#print("   - 1st order Harmonic: " + FormatFreq(round(WavelenToFreq(antennaLen*2/1.5),4)))
#print("   - 2nd order Harmonic: " + FormatFreq(round(WavelenToFreq(antennaLen*2/2.5),4)))
#print("   - 3rd order Harmonic: " + FormatFreq(round(WavelenToFreq(antennaLen*2/3.5),4)))
